...
#                                              ]),                                      
    ...
    dataset_train = VOCclassification(data_dir, 
                                      image_set='train',  
    ...
    dataset_valid = VOCclassification(data_dir,                              
                                      image_set='val',
    ...
    #                                   target_transform=encode_labels)
    # dataset_test = VOCclassification(data_dir,                              
    #                                 image_set='val',
    #                                 transform=transformations_test, 
    #                                 target_transform=encode_labels)
...
if __name__ == '__main__':
   main('../data/VOC2012_train_val', "resnet34", num=1, lr = [1.5e-4, 5e-2], epochs = 40, batch_size=8, download_data=True, save_results=True)